...
function syncGuidedNavigation(view){
  const groups={deals:['pipeline','activities','proposals','closingPlans','cadences','channels'],clients:['clients','success'],orbit:['orbitCoach','organize','playbooks'],management:['reports','growthOs','receipts','ranking','team','templates','settings']};
