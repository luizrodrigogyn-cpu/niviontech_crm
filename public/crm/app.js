...
function showView(view){
  ...
  const organize=view==='organize',orbitCoach=view==='orbitCoach',playbooks=view==='playbooks',closingPlans=view==='closingPlans',cadences=view==='cadences',channels=view==='channels',success=view==='success',ranking=view==='ranking',proposals=view==='proposals',receipts=view==='receipts',settings=view==='settings',team=view==='team',templates=view==='templates',reports=view==='reports';
  const secondary=pipeline||clients||activities||channels||cadences||success||organize||orbitCoach||playbooks||closingPlans||ranking||proposals||receipts||settings||team||templates||reports;
